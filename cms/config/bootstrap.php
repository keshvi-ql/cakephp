...
// custome config
if (file_exists(CONFIG . 'custom_configs' . DS . 'youtube.php')) {
    Configure::load('custom_configs/youtube', 'default');
}
/*
...
Security::setSalt('a_secure_random_salt_value_1234567890');
